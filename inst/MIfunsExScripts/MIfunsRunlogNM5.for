C Generates a running table file to summarize the output of NONMEM runs.
      ...
      include '/sawmill/comp/NONMEM/nm5amd64/nm/NSIZES'
     ...
     1              SEN(LVR,LVR),COR(LPAR3),NVLS,VLS(LPAR) 
      ...
      integer lth,lvr,lvr2,lpar,lpar2,lpar3,mthvr,no,lnp4,lws1,ladd,
     +        lsupp,lim1,lim2,lim3,lim4,lim5,lim6,lim7,lim8,lim11
